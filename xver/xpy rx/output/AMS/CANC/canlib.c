...
static struct can1_ams_status_1_t can1_rx_ams_status_1;
static struct can1_dbu_status_1_t can1_rx_dbu_status_1;
static struct can1_ams_temperatures_t can1_rx_ams_temperatures;
static struct can1_ams_cell_voltages_t can1_rx_ams_cell_voltages;
static struct can1_ams_cell_temperatures_t can1_rx_ams_cell_temperatures;

static struct can1_ams_status_1_t can1_tx_ams_status_1;
static struct can1_dbu_status_1_t can1_tx_dbu_status_1;
static struct can1_ams_temperatures_t can1_tx_ams_temperatures;
static struct can1_ams_cell_voltages_t can1_tx_ams_cell_voltages;
static struct can1_ams_cell_temperatures_t can1_tx_ams_cell_temperatures;

static struct can2_amk1_setpoints_1_t can2_rx_amk1_setpoints_1;
static struct can2_ivt_msg_result_u3_t can2_rx_ivt_msg_result_u3;
static struct can2_ivt_msg_result_u2_t can2_rx_ivt_msg_result_u2;
static struct can2_ivt_msg_result_u1_t can2_rx_ivt_msg_result_u1;
static struct can2_ivt_msg_result_i_t can2_rx_ivt_msg_result_i;
static struct can2_charger_config_t can2_rx_charger_config;
static struct can2_cc_status_t can2_rx_cc_status;

static struct can2_ivt_msg_result_u3_t can2_tx_ivt_msg_result_u3;
static struct can2_ivt_msg_result_u2_t can2_tx_ivt_msg_result_u2;
static struct can2_ivt_msg_result_u1_t can2_tx_ivt_msg_result_u1;
static struct can2_ivt_msg_result_i_t can2_tx_ivt_msg_result_i;
static struct can2_charger_config_t can2_tx_charger_config;
static struct can2_cc_status_t can2_tx_cc_status;
...
static uint8_t can2_ivt_msg_result_u2_flag = 0;
...
void can1_dbu_status_1_transmit() {
   ...
   can1_tx_dbu_status_1.activate_ts_button = can1_dbu_status_1_activate_ts_button_encode(dbu_status_1.activate_ts_button);
   can1_tx_dbu_status_1.ready_to_drive_button = can1_dbu_status_1_ready_to_drive_button_encode(dbu_status_1.ready_to_drive_button);
   can1_tx_dbu_status_1.dbu_temperature = can1_dbu_status_1_dbu_temperature_encode(dbu_status_1.dbu_temperature);

   can1_dbu_status_1_pack(tx_data, &can1_tx_dbu_status_1, 8);
   while(!HAL_CAN_GetTxMailboxesFreeLevel(_hcan1));
   if (HAL_CAN_AddTxMessage(_hcan1, &tx_header, tx_data, &tx_mailbox) != HAL_OK) {
       Error_Handler();
   }
...
void can2_ivt_msg_result_u3_transmit() {
   ...
   can2_tx_ivt_msg_result_u3.ivt_id_result_u3 = can2_ivt_msg_result_u3_ivt_id_result_u3_encode(ivt_msg_result_u3.ivt_id_result_u3);
   can2_tx_ivt_msg_result_u3.ivt_result_u3_system_error = can2_ivt_msg_result_u3_ivt_result_u3_system_error_encode(ivt_msg_result_u3.ivt_result_u3_system_error);
   can2_tx_ivt_msg_result_u3.ivt_result_u3_measurement_error = can2_ivt_msg_result_u3_ivt_result_u3_measurement_error_encode(ivt_msg_result_u3.ivt_result_u3_measurement_error);
   can2_tx_ivt_msg_result_u3.ivt_result_u3_channel_error = can2_ivt_msg_result_u3_ivt_result_u3_channel_error_encode(ivt_msg_result_u3.ivt_result_u3_channel_error);
   can2_tx_ivt_msg_result_u3.ivt_result_u3_ocs = can2_ivt_msg_result_u3_ivt_result_u3_ocs_encode(ivt_msg_result_u3.ivt_result_u3_ocs);
   can2_tx_ivt_msg_result_u3.ivt_msg_count_result_u3 = can2_ivt_msg_result_u3_ivt_msg_count_result_u3_encode(ivt_msg_result_u3.ivt_msg_count_result_u3);
   can2_tx_ivt_msg_result_u3.ivt_result_u3 = can2_ivt_msg_result_u3_ivt_result_u3_encode(ivt_msg_result_u3.ivt_result_u3);

   can2_ivt_msg_result_u3_pack(tx_data, &can2_tx_ivt_msg_result_u3, 6);
...
void can2_ivt_msg_result_u2_transmit() {
   ...
   can2_ivt_msg_result_u2_tx_callback(&ivt_msg_result_u2);

   can2_tx_ivt_msg_result_u2.ivt_id_result_u2 = can2_ivt_msg_result_u2_ivt_id_result_u2_encode(ivt_msg_result_u2.ivt_id_result_u2);
   can2_tx_ivt_msg_result_u2.ivt_result_u2_system_error = can2_ivt_msg_result_u2_ivt_result_u2_system_error_encode(ivt_msg_result_u2.ivt_result_u2_system_error);
   can2_tx_ivt_msg_result_u2.ivt_result_u2_measurement_error = can2_ivt_msg_result_u2_ivt_result_u2_measurement_error_encode(ivt_msg_result_u2.ivt_result_u2_measurement_error);
   can2_tx_ivt_msg_result_u2.ivt_result_u2_channel_error = can2_ivt_msg_result_u2_ivt_result_u2_channel_error_encode(ivt_msg_result_u2.ivt_result_u2_channel_error);
   can2_tx_ivt_msg_result_u2.ivt_result_u2_ocs = can2_ivt_msg_result_u2_ivt_result_u2_ocs_encode(ivt_msg_result_u2.ivt_result_u2_ocs);
   can2_tx_ivt_msg_result_u2.ivt_msg_count_result_u2 = can2_ivt_msg_result_u2_ivt_msg_count_result_u2_encode(ivt_msg_result_u2.ivt_msg_count_result_u2);
   can2_tx_ivt_msg_result_u2.ivt_result_u2 = can2_ivt_msg_result_u2_ivt_result_u2_encode(ivt_msg_result_u2.ivt_result_u2);

   can2_ivt_msg_result_u2_pack(tx_data, &can2_tx_ivt_msg_result_u2, 6);
   while(!HAL_CAN_GetTxMailboxesFreeLevel(_hcan2));
   if (HAL_CAN_AddTxMessage(_hcan2, &tx_header, tx_data, &tx_mailbox) != HAL_OK) {
       Error_Handler();
   }
...
void can2_ivt_msg_result_u1_transmit() {
   ...
   can2_tx_ivt_msg_result_u1.ivt_id_result_u1 = can2_ivt_msg_result_u1_ivt_id_result_u1_encode(ivt_msg_result_u1.ivt_id_result_u1);
   can2_tx_ivt_msg_result_u1.ivt_result_u1_system_error = can2_ivt_msg_result_u1_ivt_result_u1_system_error_encode(ivt_msg_result_u1.ivt_result_u1_system_error);
   can2_tx_ivt_msg_result_u1.ivt_result_u1_measurement_error = can2_ivt_msg_result_u1_ivt_result_u1_measurement_error_encode(ivt_msg_result_u1.ivt_result_u1_measurement_error);
   can2_tx_ivt_msg_result_u1.ivt_result_u1_channel_error = can2_ivt_msg_result_u1_ivt_result_u1_channel_error_encode(ivt_msg_result_u1.ivt_result_u1_channel_error);
   can2_tx_ivt_msg_result_u1.ivt_result_u1_ocs = can2_ivt_msg_result_u1_ivt_result_u1_ocs_encode(ivt_msg_result_u1.ivt_result_u1_ocs);
   can2_tx_ivt_msg_result_u1.ivt_msg_count_result_u1 = can2_ivt_msg_result_u1_ivt_msg_count_result_u1_encode(ivt_msg_result_u1.ivt_msg_count_result_u1);
   can2_tx_ivt_msg_result_u1.ivt_result_u1 = can2_ivt_msg_result_u1_ivt_result_u1_encode(ivt_msg_result_u1.ivt_result_u1);

   can2_ivt_msg_result_u1_pack(tx_data, &can2_tx_ivt_msg_result_u1, 6);
   while(!HAL_CAN_GetTxMailboxesFreeLevel(_hcan2));
   if (HAL_CAN_AddTxMessage(_hcan2, &tx_header, tx_data, &tx_mailbox) != HAL_OK) {
       Error_Handler();
   }
...
void can2_ivt_msg_result_i_transmit() {
   ...
   can2_tx_ivt_msg_result_i.ivt_id_result_i = can2_ivt_msg_result_i_ivt_id_result_i_encode(ivt_msg_result_i.ivt_id_result_i);
   can2_tx_ivt_msg_result_i.ivt_result_i_system_error = can2_ivt_msg_result_i_ivt_result_i_system_error_encode(ivt_msg_result_i.ivt_result_i_system_error);
   can2_tx_ivt_msg_result_i.ivt_result_i_measurement_error = can2_ivt_msg_result_i_ivt_result_i_measurement_error_encode(ivt_msg_result_i.ivt_result_i_measurement_error);
   can2_tx_ivt_msg_result_i.ivt_result_i_channel_error = can2_ivt_msg_result_i_ivt_result_i_channel_error_encode(ivt_msg_result_i.ivt_result_i_channel_error);
   can2_tx_ivt_msg_result_i.ivt_result_i_ocs = can2_ivt_msg_result_i_ivt_result_i_ocs_encode(ivt_msg_result_i.ivt_result_i_ocs);
   can2_tx_ivt_msg_result_i.ivt_msg_count_result_i = can2_ivt_msg_result_i_ivt_msg_count_result_i_encode(ivt_msg_result_i.ivt_msg_count_result_i);
   can2_tx_ivt_msg_result_i.ivt_result_i = can2_ivt_msg_result_i_ivt_result_i_encode(ivt_msg_result_i.ivt_result_i);

   can2_ivt_msg_result_i_pack(tx_data, &can2_tx_ivt_msg_result_i, 6);
   while(!HAL_CAN_GetTxMailboxesFreeLevel(_hcan2));
   if (HAL_CAN_AddTxMessage(_hcan2, &tx_header, tx_data, &tx_mailbox) != HAL_OK) {
       Error_Handler();
   }
...
void can2_cc_status_transmit() {
   ...
   can2_tx_cc_status.enable_ams_charging = can2_cc_status_enable_ams_charging_encode(cc_status.enable_ams_charging);

   can2_cc_status_pack(tx_data, &can2_tx_cc_status, 1);
   while(!HAL_CAN_GetTxMailboxesFreeLevel(_hcan2));
   if (HAL_CAN_AddTxMessage(_hcan2, &tx_header, tx_data, &tx_mailbox) != HAL_OK) {
       Error_Handler();
   }
