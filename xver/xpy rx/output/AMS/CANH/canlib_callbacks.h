 ...
 * @Retval None
 */
void can1_ams_status_1_rx_callback(ams_status_1_t* ams_status_1);
 ...
 * @Retval None
 */
void can1_ams_temperatures_rx_callback(ams_temperatures_t* ams_temperatures);
 ...
 * @Retval None
 */
void can1_ams_cell_voltages_rx_callback(ams_cell_voltages_t* ams_cell_voltages);
 ...
 * @Retval None
 */
void can1_ams_cell_temperatures_rx_callback(ams_cell_temperatures_t* ams_cell_temperatures);
