...
const osThreadAttr_t SM_task_attributes = { .name = "SM_task", .stack_size = 128
		* 4, .priority = (osPriority_t) osPriorityNormal, };
const task_info SM_task_info = { .periodicity = 0.200, .offset = 0.000,
...
const task_info IWDG_task_info = { .periodicity = 0.200, .offset = 0.010,
...
const task_info event_handler_task_info = { .periodicity = 0.100, .offset =
...
const task_info IMD_task_info = { .periodicity = 0.200, .offset = 0.012,
		.execution_time = 0.001, };
...
const task_info GPIO_task_info = { .periodicity = 0.200, .offset = 0.013,
		.execution_time = 0.001, };
...
const task_info ADC_task_info = { .periodicity = 0.200, .offset = 0.014,
		.execution_time = 0.001, };

osThreadId_t COM_task_handle;
const osThreadAttr_t COM_task_attributes = { .name = "COM_task", .stack_size =
		128 * 4, .priority = (osPriority_t) osPriorityNormal4, };
const task_info COM_task_info = { .periodicity = 0.200, .offset = 0.015,
		.execution_time = 0.040, };

osThreadId_t CAN_rx_task_handle;
const osThreadAttr_t CAN_rx_task_attributes =
		{ .name = "CAN_rx_task", .stack_size = 128 * 4, .priority =
				(osPriority_t) osPriorityBelowNormal1, };
const task_info CAN_rx_task_info = { .periodicity = 0.200, .offset = 0.055,
		.execution_time = 0.020, };

osThreadId_t CAN_tx_task_handle;
const osThreadAttr_t CAN_tx_task_attributes =
		{ .name = "CAN_tx_task", .stack_size = 128 * 4, .priority =
				(osPriority_t) osPriorityBelowNormal2, };
const task_info CAN_tx_task_info = { .periodicity = 0.200, .offset = 0.075,
		.execution_time = 0.020, };

/* Data consuming tasks */
osThreadId_t CSE_task_handle;
const osThreadAttr_t CSE_task_attributes = { .name = "CSE_task", .stack_size =
		128 * 4, .priority = (osPriority_t) osPriorityNormal5, };
const task_info CSE_task_info = { .periodicity = 0.200, .offset = 0.095,
...
const task_info COOL_task_info = { .periodicity = 0.200, .offset = 0.110,
		.execution_time = 0.001, };

/* Data simulation tasks */
osThreadId_t SIM_task_handle;
const osThreadAttr_t SIM_task_attributes = { .name = "CSE_task", .stack_size =
		128 * 4, .priority = (osPriority_t) osPriorityBelowNormal, };
const task_info SIM_task_info = { .periodicity = 0.200, .offset = 0.111,
